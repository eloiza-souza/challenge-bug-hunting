...
public class TestVideoManager {
    public static void main(String[] args) {
        ...
        try {
            Video video = VideoManagerService.createVideo("Aprendendo Java", "Curso completo de Java", "120", "curso", "25/12/2024");
        ...
        try {
            Video videoFromString = VideoManagerService.createVideo("Aprendendo Java;Curso completo de Java;120;curso;15/10/2023");
